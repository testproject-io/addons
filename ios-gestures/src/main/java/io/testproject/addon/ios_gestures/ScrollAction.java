...
@Action(name = "Scroll",
        description = "Perform a scroll action",
        summary = "Scroll up, down, left, or right")
public class ScrollAction implements IOSAction {

    @Parameter(description = "The direction to scroll. Must be 'up', 'down', 'left', or 'right'")
