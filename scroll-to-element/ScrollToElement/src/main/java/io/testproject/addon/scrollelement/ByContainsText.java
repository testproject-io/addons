...
@Action(name = "Scroll to element that contains text")
public class ByContainsText extends BaseAction implements WebAction {

    @ActionParameter
    public String targetText;

    public ExecutionResult execute(WebAddonHelper helper) {
        return performScroll(helper, By.xpath("//*[text()[contains(.," + resolveAprostophes(targetText) + ")]]"),
                "Scrolled by element that contains text");
    }
}