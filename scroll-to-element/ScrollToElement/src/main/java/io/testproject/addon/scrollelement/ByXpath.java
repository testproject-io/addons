...
@Action(name = "Scroll to element by xpath")
public class ByXpath extends BaseAction implements WebAction {

    @ActionParameter
    public String xpath;

    public ExecutionResult execute(WebAddonHelper helper) {
        return performScroll(helper, By.xpath(xpath), "Scrolled by element xpath");
    }
}