...
@Action(name = "Scroll to element by class name")
public class ByClassName extends BaseAction implements WebAction {

    @ActionParameter
    public String className;

    public ExecutionResult execute(WebAddonHelper helper) {
        return performScroll(helper, By.className(className), "Scrolled by class name");
    }
}