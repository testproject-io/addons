...
@Action(name = "Scroll to element by ID")
public class ByElementID extends BaseAction implements WebAction {

    @ActionParameter
    public String id;

    public ExecutionResult execute(WebAddonHelper helper) {
        return performScroll(helper, By.id(id), "Scrolled by element id");
    }
}