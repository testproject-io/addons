...
@Action(name = "Revoke permissions for contacts list")
public class RevokeContacts extends BaseAction implements AndroidAction {

    public ExecutionResult execute(AndroidAddonHelper helper) throws FailureException {
        return togglePermissionGroup(helper, PermissionsState.REVOKE, PermissionsGroups.CONTACTS);
    }
}