...
@Action(name = "Grant permissions for contacts list")
public class GrantContacts extends BaseAction implements AndroidAction {

    public ExecutionResult execute(AndroidAddonHelper helper) throws FailureException {
        return togglePermissionGroup(helper, PermissionsState.GRANT, PermissionsGroups.CONTACTS);
    }
}