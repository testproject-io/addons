...
@Action(name = "Grant permissions for phone calls")
public class GrantPhoneCalls extends BaseAction implements AndroidAction {

    public ExecutionResult execute(AndroidAddonHelper helper) throws FailureException {
        return togglePermissionGroup(helper, PermissionsState.GRANT, PermissionsGroups.PHONE_CALLS);
    }
}