...
@Action(name = "Revoke permissions for sensors")
public class RevokeSensors extends BaseAction implements AndroidAction {

    public ExecutionResult execute(AndroidAddonHelper helper) throws FailureException {
        return togglePermissionGroup(helper, PermissionsState.REVOKE, PermissionsGroups.SENSORS);
    }
}
