...
@Action(name = "Grant permissions for network / internet")
public class GrantNetwork extends BaseAction implements AndroidAction {

    public ExecutionResult execute(AndroidAddonHelper helper) throws FailureException {
        return togglePermissionGroup(helper, PermissionsState.GRANT, PermissionsGroups.NETWORK);
    }
}