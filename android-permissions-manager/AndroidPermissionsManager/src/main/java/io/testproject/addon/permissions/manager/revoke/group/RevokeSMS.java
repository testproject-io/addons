...
@Action(name = "Revoke permissions for SMS")
public class RevokeSMS extends BaseAction implements AndroidAction {

    public ExecutionResult execute(AndroidAddonHelper helper) throws FailureException {
        return togglePermissionGroup(helper, PermissionsState.REVOKE, PermissionsGroups.SMS);
    }
}