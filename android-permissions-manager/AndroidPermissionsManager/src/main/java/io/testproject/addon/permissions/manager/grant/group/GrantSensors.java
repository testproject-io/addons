...
@Action(name = "Grant permissions for sensors")
public class GrantSensors extends BaseAction implements AndroidAction {

    public ExecutionResult execute(AndroidAddonHelper helper) throws FailureException {
        return togglePermissionGroup(helper, PermissionsState.GRANT, PermissionsGroups.SENSORS);
    }
}