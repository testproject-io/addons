...
@Action(name = "Revoke permissions for media contents")
public class RevokeMedia extends BaseAction implements AndroidAction {

    public ExecutionResult execute(AndroidAddonHelper helper) throws FailureException {
        return togglePermissionGroup(helper, PermissionsState.REVOKE, PermissionsGroups.MEDIA);
    }
}